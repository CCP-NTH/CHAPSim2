...
!==========================================================================================================
  subroutine check_current_conservation(mh, dm)
    ...
    call Get_volumetric_average_3d(dm, dm%dpcc, mh%jx, net_jx, SPACE_INTEGRAL, 'jx_current_density')
    call Get_volumetric_average_3d(dm, dm%dccp, mh%jy, net_jy, SPACE_INTEGRAL, 'jy_current_density')
    call Get_volumetric_average_3d(dm, dm%dccp, mh%jz, net_jz, SPACE_INTEGRAL, 'jz_current_density')

    if (nrank == 0) then
        write (*, wrtfmt1el) 'net electric current (j_x) = ', net_jx
        write (*, wrtfmt1el) 'net electric current (j_y) = ', net_jy
        write (*, wrtfmt1el) 'net electric current (j_z) = ', net_jz
    end if
